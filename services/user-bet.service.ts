...
export default function useUserBetService(): ServiceProps {
  /**
   * Créer un Pari
   */
  const create = async (bet: UserBetModel): Promise<AxiosResponse> => {
   ...
   */
  const update = async (bet: UserBetModel): Promise<AxiosResponse> => {
